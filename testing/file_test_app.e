...
feature -- Tests
	...
	test_write_and_read_text
		...
		local
			...
			l_ignore: BOOLEAN
		do
			print ("test_write_and_read_text: ")
	...
	test_write_and_read_lines
		...
		local
			...
			l_ignore: BOOLEAN
		do
			print ("test_write_and_read_lines: ")
	...
	test_write_and_read_bytes
		...
		local
			...
			l_ignore: BOOLEAN
		do
			print ("test_write_and_read_bytes: ")
	...
	test_files_with_extension
		...
		local
			...
			l_ignore: BOOLEAN
		do
			print ("test_files_with_extension: ")
	...
	test_expanded_convenience
		...
		local
			...
			l_ignore: BOOLEAN
		do
			print ("test_expanded_convenience: ")
